        ...
        completion = client.chat.completions.create(
            ...
            tools=[
                ...
                ChatCompletionToolParam(
                    ...
                    function=FunctionDefinition(
                        name="notify",
                        description="Sends notification message to Telegram chat",
                        parameters={
...
if __name__ == "__main__":
    ...
    run_prompt("Собери саммари коммитов в репозитории за сегодняшний день и отправь его в чат в телеграме", chat_id)
